...
def publish(
    *,
    ...
    if pr_config.mode != "github_action":
        return PublishResult(mode="local", pr_url=None, pushed_branch=None, skipped_reason=None)

    if shutil.which("gh") is None:
        return PublishResult(
            mode="local", pr_url=None, pushed_branch=None,
    ...
    if pr_proc.returncode != 0:
        return PublishResult(
            mode="github_action", pr_url=None,
